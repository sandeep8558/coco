...
<!-- Header image -->
    ...
    <div class="row m-0 justify-content-center align-items-center text-center w-100 position-absolute z-1 h-100 opacity-75">
        <div class="col">
            <!-- <h1 class="text-light opacity-100 display-3 fw-bold" data-aos="flip-left">Facilities</h1> -->
        </div>
    </div>
    <img src="/img/coco_facilities.png" alt="contact_us" class="w-100" data-aos-delay="1000" data-aos-duration="3000">
    </div>
        ...
        <div class="container">
                <div class="row justify-content-center gapsectionsecond">
                    <div class="col-lg-7 text-center">
                        <div class="pb-1 mb-1">
                            <h3 class="fs-1 fw-bolder text-voilet">Facilities at Coco Preschool</h3>
                            <hr class="w-50 mx-auto">
                        </div>
                        <p class="description-p text-muted pe-0 pe-lg-0">
                        Our preschool offers bright, spacious classrooms, a secure outdoor play area, and a well-stocked learning center to encourage creativity and exploration. We provide age-appropriate learning materials, child-friendly furniture, and a safe, nurturing environment for holistic development.
                        </p>
                    </div>
                </div>
